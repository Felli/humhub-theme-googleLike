...
<html lang="en">
	...
	<!-- start: Theme CSS -->
	<link href="https://192.168.50.40/humhub//themes/googleLike/css/styles1.css" rel="stylesheet">
...
<script type="text/javascript"
            src="https://192.168.50.40/humhub//themes/googleLike/js/scripts1.js"></script>            
 	...
 	<div class="col-md-12">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse1">
          ...
          <ul class="nav navbar-nav navbar-right">
             <li><a href="<?php echo $this->createUrl('//user/profile', array('uguid' => Yii::app()->user->guid)); ?>" target="_ext"><?php echo Yii::app()->user->displayName; ?>+</a></li>
             <li>
